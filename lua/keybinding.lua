...
vim.keymap.set("n", "<leader>ff", builtin.find_files, { desc = "Telescope find files" }, opt)
vim.keymap.set("n", "<leader>fo", builtin.oldfiles, { desc = "Telescope find files" }, opt)
vim.keymap.set("n", "<leader>fc", builtin.current_buffer_fuzzy_find, { desc = "Telescope search in current buf"}, opt)
vim.keymap.set("n", "<leader>fs", builtin.grep_string, { desc = "Telescope live grep word under cursor" }, opt)
vim.keymap.set("n", "<leader>fg", builtin.live_grep, { desc = "Telescope live grep" }, opt)
vim.keymap.set("n", "<leader>fb", builtin.buffers, { desc = "Telescope buffers" }, opt)
vim.keymap.set("n", "<leader>fh", builtin.help_tags, { desc = "Telescope help tags" }, opt)
